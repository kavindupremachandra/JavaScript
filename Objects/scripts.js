...
nimal.partner='sanduni';

nimal.domarry=function(){
    console.log("nimal is married");
}
console.log(nimal.domarry());
console.log(nimal);
...
console.log(kasun);
console.log(typeof(kasun));
console.log(typeof(kasun.projects));
console.log(typeof(nimal.yearOfBirth));
console.log(typeof(nimal.subjects));